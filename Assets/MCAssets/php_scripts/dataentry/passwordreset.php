...
$passwordreset = "SELECT
  contents.Username, contents.User_ID, contents.Email
FROM contents
 Where contents.Username = '" . $username . "' and contents.Email = '" . $email . "'";
    echo $passwordreset;
$result = mysqli_query($conn, $passwordreset) or die("2:name check query failed");
